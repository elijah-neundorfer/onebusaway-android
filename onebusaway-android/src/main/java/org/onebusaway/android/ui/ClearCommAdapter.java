...
public class ClearCommAdapter extends RecyclerView.Adapter<ClearCommAdapter.ClearCommHolder> {
    ...
    ArrayList<DataAccessDescriptor> dataAccessDescriptors = new ArrayList<DataAccessDescriptor>() {{
        add(new DataAccessDescriptor(
                ...
                "Network State",
                "create more descriptive error messages if there is a problem with loading stops or arrivals (e.g., do you have airplane mode on?)",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Internet Connection",
                "get status of buses and display them to the user",
                false,
                true,
                "the bus statuses are stored online",
                false,
                "N/A"
        ));
        add(new DataAccessDescriptor(
                ...
                "Device Location",
                "access the GPS or network (Wi-Fi, cell tower) location of your device so we can show your location on the map and show bus stops near you",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device Storage",
                "check for the presence of an SD card (or internal storage) so you can save or restore your favorite starred stops",
                true,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Phone Startup Notification",
                "schedule your reminders to alert you when the bus is approaching",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                "com.joulespersecond.seattlebusbot.permission.TRIP_SERVICE",
                "Trip Service Notification",
                "schedule your reminders to alert you when the bus is approaching",
                false,
                false,
                "N/A",
        ...
        add(new DataAccessDescriptor(
                ...
                "Phone Wake State",
                "make sure that your phone doesn't go to sleep while your reminder alarms are being scheduled with the Android operating system (otherwise your reminders wouldn't work!)",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Android Launcher",
                "create icons on your home screen for a specific stop, so you can tap on that stop icon from your home screen and immediately see arrivals",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device vibration",
                "vibrate your phone when a reminder is triggered",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Account Status",
                "make sure that if the user removes a Google account from the device that they are logged out of the social features (Embedded Social) of OneBusAway.",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "IMEI/MEID",
                "create an anonymous ID for analytics purposes",
                false,
                true,
                "send a hashed version of the phone's unique ID (IMEI/MEID) to the server to determine unique users",
                false,
                "N/A"
        ));
    }};
